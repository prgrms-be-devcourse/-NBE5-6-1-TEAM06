...
<main class="container">
    <div class="menu-name">
        <strong>${userName}</strong> 님의 주문 목록입니다
    </div>
    <c:choose>
    <c:when test="${empty orderList}">
        <div class="no-order">
            <div class="center-align" style="margin-top: 100px; margin-bottom: 150px">
                <i class="material-icons large red-text">cancel</i>
                <h4 class="red-text">주문 내역이 없습니다.</h4>
            </div>
        </div>
    </c:when>
    <c:otherwise>
                ...
                <table class="order-table">
                    ...
                    <tr>
                        <th colspan="5" style="text-align: left;">
                            ...
                            (배송예정일: ${order.formattedExpectedDeliveryAt})
                        </th>
                    </tr>
